...
(function() {
  ...
  jQuery(function() {
    ...
    return $('.more_details').on("click", function(e) {
      e.preventDefault();
      $(this).children(".icon").toggleClass('is_hidden');
      return $(this).closest('.project').children(".more_details_box").toggleClass("is_hidden");
    });
  });
