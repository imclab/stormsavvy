...
describe WeatherEventsController do
  ...
  # WeatherEvent. As you add validations to WeatherEvent, be sure to
  ...
  # WeatherEventsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all weather_events as @weather_events" do
      ...
      assigns(:weather_events).should eq([weather_event])
    end
  end
